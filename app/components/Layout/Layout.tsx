...
const { MapPin, Phone, Building2, Home, Plane, Key } = Lucide;
    ...
    <div className={styles.layoutWrapper}>
        ...
        <div className="container">
          <div className={styles.footerGrid}>
            ...
            <div className={styles.footerCol}>
              ...
              <p className={styles.footerDesc}>
                Experience a refined Australian-themed luxury beachside homestay
                in Mahabalipuram. Enjoy pristine beach views, warm service, and
                local heritage sights in comfort.
              </p>
            ...
            <div className={styles.footerCol}>
              ...
              <p className={styles.footerContactInfo}>
                <MapPin size={16} /> <strong>Address:</strong>
                <br />
                No 1, Mayana Salai,
                <br />
              ...
              <p className={styles.footerContactInfo}>
                <Phone size={16} /> <strong>Direct Bookings:</strong>
                <br />
          ...
          <div className={styles.footerMapSection}>
            ...
            <div className={styles.footerMapCard}>
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d235.41592943895512!2d80.19659227895094!3d12.622208709934!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2sin!4v1783151943011!5m2!1sen!2sin"
                loading="lazy"
                allowFullScreen
          ...
          <div className={styles.footerBottom}>
            <p>
              ...
              Reserved. Designed with Coastal Luxury.
            </p>
          </div>
        </div>
      </footer>
      ...
      <div className={`${styles.mobileStickyCta} glass-panel`}>
        <div className={styles.stickyCtaContainer}>
          ...
          <a href="tel:+919042444567" className="btn btn-primary btn-sm">
            Call Now
          </a>
        </div>
      </div>
