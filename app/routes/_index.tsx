...
export const meta: MetaFunction = () => {
  return [
    ...
    { name: "description", content: "Experience premium Australian-themed beach homestay in Mahabalipuram. Cozy rooms, sea-view terrace, high-speed WiFi, and warm hospitality just 800m from the beach." },
    { name: "keywords", content: "Australian themed resort in Mahabalipuram, beach resort in Mahabalipuram, luxury stay near beach, affordable luxury resort, family-friendly resort, staycation in Mahabalipuram, beach view resort" },
  ];
};
...
export default function Index() {
  return (
    <Layout>
      ...
      <section className={styles.heroSection}>
        <div className="container">
          <div className={styles.heroContent}>
            ...
            <p>
              Step into a world of refined comfort and warm hospitality. Designed with Australian-inspired 
              elegance and modern convenience, we are your gateway to an unforgettable beachside escape.
            </p>
            <div className={styles.heroCtas}>
              <a href="#booking-section" className="btn btn-primary">
                Book Your Beach Stay
              </a>
              <a href="#about-highlight" className="btn btn-outline-white">
                Explore Resort
              </a>
            </div>
          </div>
      ...
      <section className="section-padding" id="about-highlight">
        <div className="container">
          <div className={styles.highlightsHeader}>
            ...
            <p>
              Experience the perfect balance of accessibility, tranquil beach living, 
              and authentic Indian ocean charm tailored for international and domestic travelers.
            </p>
          </div>
      ...
      <section className={`section-padding ${styles.accomSection}`}>
        <div className="container">
          <div className="grid-2">
            <div className={`${styles.accomImageWrapper} ${styles.surfingRibbon}`}>
              <img 
            ...
            <div className={styles.accomContent}>
              ...
              <p>
                Whether you're seeking a romantic weekend getaway, a family vacation, or a peaceful solo retreat, 
                our property offers the ultimate sanctuary. Our unique Australian-style interiors and relaxed coastal 
                living atmosphere make every stay comfortable, memorable, and affordable.
              </p>
              <p>
                If you are searching for an affordable stay in Mahabalipuram or a peaceful beach homestay in Mahabalipuram, 
                The Aussie House delivers the exact balance of premium comfort, prime location, and hospitality that feels like home.
              </p>
      ...
      <section className={`section-padding ${styles.amenitiesSection}`}>
        <div className="container">
          <div className={styles.highlightsHeader}>
            ...
            <p>
              Everything you need for a comfortable beachside holiday, workation, or family gathering.
            </p>
          </div>
      ...
      <section className={`section-padding ${styles.bookingSection}`} id="booking-section">
        <div className="container">
          <div className={styles.highlightsHeader}>
            <h2 className="center">Book Your Coastal Getaway</h2>
            <p style={{ color: 'rgba(255, 255, 255, 0.9)' }}>
              We partner with the world's leading booking platforms to make your reservation secure, simple, and transparent. 
              Click below to book directly on your platform of choice:
            </p>
          </div>
        ...
        <div className="container">
          <div className={styles.founderCard}>
            ...
            <div className={styles.founderInfo}>
              ...
              <p>
                We represent a unique fusion of Australian hospitality warmth and coastal Indian charm. 
                Inspired by the relaxed lifestyle of Australia's beachside culture, we've created a sanctuary 
                where comfort meets elegance. I personally supervise every aspect of your stay to ensure a home-like 
                environment where you feel entirely safe and pampered.
              </p>
              <p>
                My deep knowledge of Mahabalipuram's UNESCO sites, local seafood dining, surfing hubs, 
                and hidden beaches guarantees you get an authentic local experience, not just a hotel stay.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding">
        <div className="container">
          <div className={styles.highlightsHeader}>
            ...
            <p>
              Mahabalipuram is one of Tamil Nadu's most cherished coastal heritage hubs. 
              Staying with us grants you immediate access to famous sights and adventure spots:
            </p>
          </div>
          ...
          <div className="grid-3">
            ...
            <div className={styles.attractionCard}>
              ...
              <div className={styles.attractionOverlay}>
                ...
                <p>Stunning 8th-century stone temple standing tall on the coastline. Perfect for morning cultural walks.</p>
              </div>
            </div>
            ...
            <div className={styles.attractionCard}>
              ...
              <div className={styles.attractionOverlay}>
                ...
                <p>Famous surfing breaks suitable for beginners and professionals, surrounded by vibrant beachfront cafes.</p>
              </div>
            </div>
            ...
            <div className={styles.attractionCard}>
              ...
              <div className={styles.attractionOverlay}>
                ...
                <p>Taste fresh, locally caught catch prepared with authentic coastal Indian recipes and spices.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding" style={{ backgroundColor: 'var(--color-light)' }}>
        <div className="container">
          <div className={styles.highlightsHeader}>
            ...
            <p>A visual journey through the cozy, high-quality spaces waiting for you.</p>
          </div>

          <div className={styles.galleryGrid}>
            <div className={styles.galleryItem}>
              <img src="https://images.unsplash.com/photo-1618773928121-c32242e63f39?auto=format&fit=crop&w=400&q=80" alt="Resort Cozy Rooms" />
            </div>
            <div className={styles.galleryItem}>
              <img src="https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?auto=format&fit=crop&w=400&q=80" alt="Australian Coastal Living" />
            </div>
            <div className={styles.galleryItem}>
              <img src="https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=400&q=80" alt="Beachfront Chairs" />
            </div>
            <div className={styles.galleryItem}>
              <img src="https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?auto=format&fit=crop&w=400&q=80" alt="Mahabalipuram Beach homestay view" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className={styles.mapCard}>
            <div className="grid-2" style={{ gap: 0 }}>
              <div className={styles.mapContent}>
                ...
                <p>
                  Our resort sits perfectly nestled in a tranquil beachside neighborhood, 
                  allowing you to sleep peacefully while keeping you just 800m away from the sandy shores 
                  and within minutes of all major UNESCO monuments and surfing points.
                </p>
                <a 
              ...
              <div style={{ height: '100%', minHeight: '350px', background: '#e5e3df' }}>
                <iframe 
